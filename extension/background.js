...
if (initStorage('v0.8.92', true)) {
	...
	if (localStorage.onlyreading === 'yes') { localStorage.onlyreading = 'true'; }
	if (localStorage.onlyreading === 'no') { localStorage.onlyreading = 'false'; }
	...
	for (var i = 0; i * 2 < rcxDict.prototype.numList.length; i++) {
